...
- =*_named= means three arguments: subject, pattern, functions. The
  ...
  capture groups, e.g. "(?P<groupName1>subPattern1)", read the [[https://cran.r-project.org/web/packages/namedCapture/vignettes/Three_argument_syntax.html][Three
...
- =*_variable= means a variable number of arguments in which the
  ...
  functions, and lists. Read the [[https://cran.r-project.org/web/packages/namedCapture/vignettes/Variable_argument_syntax.html][Variable argument syntax]] vignette for
