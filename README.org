...
- [[https://CRAN.R-project.org/package=rex][rex]] provides R functions for generating regular expression pattern
  strings. (=namedCapture::*_variable= functions also internally
  generate regex pattern strings)
