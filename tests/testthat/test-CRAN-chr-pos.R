...
test_engines("str_match_named returns character matrix", {
...
test_engines("str_match_named returns data.frame", {
...
test_engines("str_match_named converts with as.integer", {
...
test_engines("str_match_all_named returns list of character matrices", {
...
test_engines("str_match_all_named returns list of data.frames", {
  keep.digits <- function(x)as.integer(gsub("[^0-9]", "", x))
  conversion.list <- list(chromStart=keep.digits, chromEnd=keep.digits)
