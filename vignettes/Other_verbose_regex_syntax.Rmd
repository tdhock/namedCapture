---
title: "Other verbose regex syntax"
author: "Toby Dylan Hocking"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Other verbose regex syntax}
...
can be turned on via the regex `(?x)`. We have translated the rex log
...
- Type conversion functions. In `namedCapture::*_variable` they are
  ...
  whereas in rex and `namedCapture::*_named` they are specified after
  the pattern. 
