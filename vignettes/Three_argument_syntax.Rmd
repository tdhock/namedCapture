...
- `pattern` is the (character scalar) regular expression with named
  capture groups used for extraction. The named capture groups should be literally specified, e.g. `(?<group_name>subpattern)`
...
This feature makes it easy to select particular elements of the extracted data by name, e.g.
